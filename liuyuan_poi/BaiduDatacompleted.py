...
leftBottom=[108.935954,34.259931]
rightTop=[108.937149,34.261859]
partition=1
urlRoot='http://api.map.baidu.com/place/v2/search?'
poiNames=['生活服务','丽人']
AK='vxCvnNy8lMZdZNl0ugq4MlujIW4H3TKD'
...
def scrapingData(leftBottom,rightTop,partition,urlRoot,poiNames,AK,csvFile):
